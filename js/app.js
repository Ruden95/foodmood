(() => {
    ...
    function initSliders() {
        if (document.querySelector(".team-members__slider")) new core(".team-members__slider", {
            modules: [ Navigation, Pagination, Scrollbar, Keyboard, Mousewheel, Autoplay, EffectFade, EffectFlip, EffectCube, EffectCoverflow ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            spaceBetween: 30,
        ...
        if (document.querySelector(".our-categories__slider")) new core(".our-categories__slider", {
            modules: [ Navigation, Pagination, Scrollbar, Keyboard, Mousewheel, Autoplay, EffectFade, EffectFlip, EffectCube, EffectCoverflow ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
